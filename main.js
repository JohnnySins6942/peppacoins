        ...
        if(user)
        {
            ...
            else if(window.location.href.indexOf("trade") > -1)
            {
                ...
                $(document).ready(function(){
                    ...
                    btn.onclick = function() {
                        ...
                        var peppaValue = localStorage.getItem("PeppaValue");
                                ...
                                TenGc.value ="Cost After Fees: "  + ((10/Number(peppaValue) + (10/Number(peppaValue) * 0.075)).toFixed(4)).toString() + " PEPPAS";
                                cost.innerHTML="10$"
                ...
                var peppaValue = localStorage.getItem("PeppaValue");
                            ...
                            TenGc.value ="Cost After Fees: "  + ((25/Number(peppaValue) + (25/Number(peppaValue) * 0.075)).toFixed(4)).toString() + " PEPPAS";
                            cost.innerHTML="25$"
                    ...
                    btn2.onclick = function() {
                        ...
                        var peppaValue = localStorage.getItem("PeppaValue");
                            ...
                            TenGc.value ="Cost After Fees: "  + ((50/Number(peppaValue) + (50/Number(peppaValue) * 0.075)).toFixed(4)).toString() + " PEPPAS";
                            cost.innerHTML="50$"
                ...
                var peppaValue = localStorage.getItem("PeppaValue");
                            ...
                            TenGc.value ="Cost After Fees: "  + ((100/Number(peppaValue) + (100/Number(peppaValue) * 0.075)).toFixed(4)).toString() + " PEPPAS";
                            cost.innerHTML="100$"
                ...
                var peppaValue = localStorage.getItem("PeppaValue");
                            ...
                            TenGc.value ="Cost After Fees: "  + ((250/Number(peppaValue) + (250/Number(peppaValue) * 0.075)).toFixed(4)).toString() + " PEPPAS";
                            cost.innerHTML="250$"
                    ...
                    btn5.onclick = function() {
                        ...
                        var peppaValue = localStorage.getItem("PeppaValue");
                            ...
                            TenGc.value ="Cost After Fees: "  + ((500/Number(peppaValue) + (500/Number(peppaValue) * 0.075)).toFixed(4)).toString() + " PEPPAS";
                            cost.innerHTML="500$"
                ...
                var peppaValue = localStorage.getItem("PeppaValue");
                            ...
                            TenGc.value ="Cost After Fees: "  + ((1000/Number(peppaValue) + (1000/Number(peppaValue) * 0.075)).toFixed(4)).toString() + " PEPPAS";
                            cost.innerHTML="1000$"
                ...
                var peppaValue = localStorage.getItem("PeppaValue");
                            ...
                            TenGc.value ="Cost After Fees: "  + ((2500/Number(peppaValue) + (2500/Number(peppaValue) * 0.075)).toFixed(4)).toString() + " PEPPAS";
                            cost.innerHTML="2500$"
        ...
        querySnapshot.forEach((doc) => {
            if(doc.exists)
            {
                Auth.createUserWithEmailAndPassword(email.value, password.innerHTML).then(function (){
                    ...
                    var referrals123 = data.Referrals;
                    var multiplier123 = Number(data.Multiplier)
                    
        
                    db.collection("users").doc(user.uid).set(docData).then(() => {
                        referrals123.push(user.uid);
                        multiplier123 += Number(0.05);
                        db.collection("users").doc(doc.id).update({
                            Referrals: referrals123,
                            Multiplier: multiplier123
                        }).then(() => {
                            var docRef1 = db.collection("data").doc("data");
                            docRef1.get().then((doc1) => {
                                var data = doc1.data();
                    ...
                    docRef.get().then((Senddoc) => {
                        if (Senddoc.exists) {
                            ...
                            if (coins >= Number(TransactionAmount.value) + Number(NetworkFee)){
                                ...
                                var gggggg = data.Transactions;
                                gggggg.push(TransactionObj);
                                ...
                                docRef.get().then((Receivedoc) => {
                                    if (Receivedoc.exists) {
                                        ...
                                        var tempReceivedataTransactions = Rdata.Transactions;
                                        tempReceivedataTransactions.push(ReceiveTransactionObj);
                                        var tempReceivedataNotifs = Rdata.Notifications;
                                        tempReceivedataNotifs.push(NotificationsObj);
                                        db.collection("users").doc(doc.id).update({
                                            Coins: ReceivetempCoin,
                                            Notifications: tempReceivedataNotifs,
                                            Transactions: tempReceivedataTransactions
                                        }).then(() => {
                                                var docRef1 = db.collection("data").doc("data");
                                                docRef1.get().then((doc1) => {
                                                    var data = doc1.data();
                ...
                var docRef = db.collection("users").doc(doc.id);
                                docRef.get().then((Receivedoc) => {
                                    if (Receivedoc.exists) {
                                        ...
                                        var ggg = Rdata.Transactions;
                                        ggg.push(ReceiveTransactionObj);
                                        db.collection("users").doc(doc.id).update({
                                            Transactions: ggg,
                                            Coins: ReceivetempCoin,
        ...
        if(doc.exists)
        {
            ...
            docRef2.get().then((Senddoc) => {
                if (Senddoc.exists) {
                    ...
                    var ggg = data.Transactions;
                    ggg.push(TransactionObj);
                    db.collection("users").doc(Auth.currentUser.uid).update({
